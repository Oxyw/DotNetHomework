    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                //生成订单order1
                Order order1 = new Order(c1, "The Fifth Avenue", new DateTime(2021, 04, 09, 18, 59, 10));
                ...
                //生成订单order2
                Order order2 = new Order(c2, "WHU University", odli, new DateTime(2021, 04, 09, 18, 59, 25));
                order2.AddItem(od3);

                //生成订单order3
                Order order3 = new Order(c3, "Lucy's Home", new DateTime(2021, 04, 10, 18, 59, 10));
                ...
                List<Order> q1= s1.ShowByPrice();
                q1.ForEach(o => Console.WriteLine(o));
                ...
                */
                ...
                try
                {
                    s1.Export("orders.xml");
                    s2.Import("orders.xml");
                }
